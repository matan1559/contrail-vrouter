...
int
vr_dp_offloads_mpls_add(struct vr_nexthop *nh, int label)
{
...
int
vr_dp_offloads_vxlan_add(struct vr_nexthop * nh, int vnid)
{
    struct vr_offload_tag *otag;
...
int
vr_dp_offloads_mpls_del(int label)
{
    struct vr_offload_tag *otag;
...
int
vr_dp_offloads_vxlan_del(int vnid)
{
    struct vr_offload_tag *otag;
    struct vrouter *router = vrouter_get(0);
...
struct vr_offload_ops vr_dp_offload_ops = {
    ...
    .voo_mpls_add = vr_dp_offloads_mpls_add,
    .voo_mpls_del = vr_dp_offloads_mpls_del,
    .voo_vxlan_add = vr_dp_offloads_vxlan_add,
    .voo_vxlan_del = vr_dp_offloads_vxlan_del,
};
