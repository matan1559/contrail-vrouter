...
enum vr_malloc_objects_t {
    ...
    VR_OFFLOAD_FLOW_OBJECT,
    VR_OFFLOAD_TAG_OBJECT
};
...
struct host_os {
    ...
    int (*hos_offload_flow_index_get)(struct vr_packet *pkt, unsigned int *res);
...
#define vr_offload_flow_index_get       vrouter_host->hos_offload_flow_index_get
